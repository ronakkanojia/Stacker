...
export const GameScene: React.FC<GameSceneProps> = ({
  ...
  // Current moving block properties
  ...
  const placeBlock = () => {
    ...
    // Confetti every 10 blocks (skip on mobile for performance)
    if (!isMobile && stack.length % 10 === 0) {
        confetti({
            particleCount: 100,
            spread: 70,
            origin: { y: 0.6 }
  ...
  return (
    <>
      ...
      {/* Dynamic Starfield - Reduced count for mobile */}
      <StarField count={isMobile ? 100 : 200} />

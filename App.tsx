      ...
      <div className="absolute inset-0 pointer-events-none flex flex-col justify-between z-10 font-sans">
          ...
          {gameStatus === GameStatus.MENU && (
              <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-b from-black/40 via-black/20 to-black/40 backdrop-blur-[3px] pointer-events-auto transition-opacity duration-500">
                  ...
                  {/* High Score Display */}
                  {highScore > 0 && (
                    <div className="absolute bottom-16 left-1/2 -translate-x-1/2 flex items-center gap-3 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 backdrop-blur-md px-8 py-4 rounded-full border border-yellow-500/30 shadow-lg">
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-white font-black text-xl tabular-nums">{highScore}</span>
                        </div>
                    </div>
                  )}
          ...
          {gameStatus === GameStatus.GAME_OVER && (
              <div className="absolute inset-0 flex items-center justify-center bg-black/70 backdrop-blur-md pointer-events-auto transition-opacity duration-300">
                  <div className="relative bg-gradient-to-br from-gray-900/90 to-black/90 border-2 border-white/20 p-12 rounded-3xl backdrop-blur-xl shadow-2xl flex flex-col items-center max-w-md w-full mx-4 transform transition-all animate-[slideUp_0.5s_ease-out]">
                      ...
                      <div className="relative mb-8">
                        ...
                        <h2 className="relative text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-pink-400 tracking-tight drop-shadow-lg">
                          GAME OVER
                        </h2>
                      </div>
                      ...
                      <div className="flex flex-col items-center mb-8 relative">
                        ...
                        <div className="relative">
                          ...
                          <span className="relative text-9xl font-black text-white drop-shadow-[0_0_40px_rgba(255,255,255,0.5)] leading-none tabular-nums">{score}</span>
                        </div>
                      </div>

                      {/* High Score Badge */}
                      <div className="flex items-center gap-3 mb-10 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 px-8 py-3 rounded-full border border-yellow-500/30 backdrop-blur-sm relative">
                        <svg className="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                          <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                        </svg>
                        <div className="flex items-baseline gap-2">
                          <span className="text-yellow-200/70 text-sm font-semibold tracking-wider">BEST:</span>
                          <span className="text-white text-xl font-black tabular-nums">{highScore}</span>
                        </div>
                      </div>
                      ...
                      <button 
                          ...
                          className="group relative px-10 py-5 bg-gradient-to-r from-white to-gray-100 text-black font-black text-xl tracking-[0.2em] rounded-2xl w-full hover:scale-105 active:scale-95 transition-all shadow-[0_0_30px_rgba(255,255,255,0.3)] hover:shadow-[0_0_50px_rgba(255,255,255,0.5)] overflow-hidden"
                      >
